...
# robot_lab-audit Basic Usage Demo
#
...
# Wire the tools to the analyst robot so they carry the correct robot_name
...
# Remove the global registration so only per-robot hooks fire
